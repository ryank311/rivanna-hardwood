...
import largeFavicon from 'file!images/favicon.png';
...
const config = {
  ...
  meta: [
    ...
    { "name": "description", "content": "Rivanna Wood Floors LLC is a local wood flooring specialist that supports residential and commercial businesses in the Rivanna & Charlottesville area." },
    { "name": "og:title", "content": "Rivanna Wood Floors LLC" },
    { "name": "og:description", "content": "Rivanna Wood Floors LLC is a local wood flooring specialist that supports residential and commercial businesses in the Rivanna & Charlottesville area." },
