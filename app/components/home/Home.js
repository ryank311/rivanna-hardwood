            ...
            <div className="col-sm-6 col-sm-offset-3">
              <div className={inputGroupContainer}>
                ...
                <span className="input-group-btn">
                  <button className="btn btn-default" type="button" onClick={this.state.handleEmailSubmit}>Submit</button>
                </span>
              </div>
            </div>
          </div>
              ...
              <div className="row">
                <InfoCard scrollAnimate={800}>
                  ...
                  <div className="col-sm-8">
                    ...
                    <p>
                        ...
                        result. Our clients can expect to see a beautiful final product, completed in a
                        timely and efficient manner, and ending with a thorough and detailed cleaning.
                    </p>
                  </div>
                </InfoCard>
                <InfoCard scrollAnimate={1250} fadeDirection="fade-in-right">
                  <div className="col-sm-8">
                    ...
                    <p>
                        ...
                        Floors.  A few years later, he became co-owner of Albemarle Floors, improving
                        the standard of work, made new and valuable customer relationships, improved
                        efficiency, and researched new methods of flooring applications.  During his
                        last couple years of co-owning Albemarle Floors he was completing the Business
                ...
                <InfoCard scrollAnimate={1700}>
                  ...
                  <div className="col-sm-8">
                    ...
                    <p>
                        Chris got back into flooring after graduation immediately realizing the
                        demand for his high quality floor work and returning to his true
